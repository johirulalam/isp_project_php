				...
				<div class="page-inner">
					<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="#">Between dates reports</a>
							</li>
						</ul>
					</div>
					<div class="row">
...
$sql="select * from tblclient   
	join tblpaid on tblclient.UserID=tblpaid.UserId  where date(tblpaid.CreationDate) between '$fdate' and '$tdate'";
...
{               ?>											
									        ...
									        <td><a href="edit-payment.php?id=<?php  echo $row->id;?>"class="btn btn-sm btn-primary">Edit</a>
									</tr>
												<?php $cnt=$cnt+1;}} ?>
											</tbody>
										</table>
