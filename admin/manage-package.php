...
{               ?>												
												<tr>
													...
													<td><a href="edit-services-details.php?editid=<?php echo $row->ID;?>" class="btn btn-sm btn-primary">Edit</a>
														<a href="delete-services.php?editid=<?php echo $row->ID;?>" class="btn btn-sm btn-danger">Delete</a>
